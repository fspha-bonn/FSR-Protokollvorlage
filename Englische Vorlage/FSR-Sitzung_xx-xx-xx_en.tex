...
\begin{document}
	...
	\Minutes{German}{01.01.2000}{for}{against}{abst.}
	...
	\End
	\Signs
	%\DCFSR[Time]{Date} % For online meetings; First Argument only, if time differs
	\NFSR[Time]{Date}{Place} % First Argument only, if time differs, otherwise [Time] can be removed
...
% \Attendance{Persons,}{}
% - Syntax VERY important, arguments must end with ",}"!
%   For a short list separate the names in the first argument with commas,
%   leave the second argument empty
%   For a list as appendix in two columns, split names into first and second argument
...
% \begin{poll-list}[ll]{Poll}{Question}    Option & Votes\\    \end{poll-mo}
...
% FSR, FSV, FSVV, Arbeitskreis, FSK, Fachgruppe, FK, BK, AStA